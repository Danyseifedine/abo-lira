...
const form = useForm({
    ...
    meta_title_en: props.product.meta_title_en || '',
    meta_title_ar: props.product.meta_title_ar || '',
    meta_description_en: props.product.meta_description_en || '',
    meta_description_ar: props.product.meta_description_ar || '',
        ...
        <form @submit.prevent="submit" class="space-y-6">
            ...
            <template v-if="showPriceAndStockFields">
                ...
                <div class="space-y-2">
                    ...
                    <Hint :text="__('datatable.images_hint_edit')" />
                </div>
            </template>
