...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create Color', href: route('super-admin.product-colors.create') },
];
</script>
...
<template>
    <ActionLayout
        ...
        description="Fill in the details below to create a new product color"
        :breadcrumbs="breadcrumbs"
        :back-href="route('super-admin.product-colors.index')"
        :show-card="false"
        max-width="full"
        card-title="Color Information"
        card-description="Fill in the details below to create a new product color"
    >
        <Head title="Create Product Color" />
        ...
        <template #footer>
            <div class="flex justify-end gap-2">
                ...
                <DashboardButton @click="submit" :loading="form.processing" variant="default"> Create Color </DashboardButton>
            </div>
        </template>
    </ActionLayout>
</template>
