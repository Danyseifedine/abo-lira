                ...
                <div class="contact__info border-radius-5">
                    <div class="contact__info--items">
                        ...
                        <div class="contact__info--items__inner d-flex align-items-center">
                            ...
                            <a href="https://wa.link/03etwr" class="text-white">+961 70 025 668</a>
                        </div>
                    </div>
                    <div class="contact__info--items">
                        ...
                        <div class="contact__info--items__inner d-flex align-items-center">
                            ...
                            <div class="contact__info--content">
                                <p class="contact__info--content__desc text-white">Lebanon, Barja</p>
                            </div>
                        </div>
                    </div>
                    <div class="contact__info--items">
                        <h3 class="contact__info--content__title text-white mb-15">Follow Us</h3>
                        <ul class="contact__info--social d-flex align-items-center">
