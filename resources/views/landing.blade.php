                    ...
                    <div class="hero__enhanced--content mt-4">
                        ...
                        <div class="hero__cta--buttons d-flex gap-3 justify-content-center flex-wrap mb-4">
                            <a href="{{ route('shop') }}" class="hero__btn hero__btn--primary"
                                aria-label="{{ __('landing.shop_now') }} - {{ __('landing.hero_description') }}">
                                <i class="fas fa-shopping-bag me-2"></i>
                                {{ __('landing.shop_now') }}
                            </a>
                            <a href="{{ route('about') }}" class="hero__btn hero__btn--secondary hero-learn-more"
                                aria-label="{{ __('landing.learn_more') }} {{ __('nav.about_us') }}">
                                <i class="fas fa-info-circle me-2"></i>
                                {{ __('landing.learn_more') }} {{ __('nav.about_us') }}
                            </a>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 mb-30">
                        <div class="banner__items position__relative">
                            <a class="banner__thumbnail display-block" href="{{ route('track-order') }}"><img
                                    ...
                                    style="height: 230px; object-fit: cover;" loading="lazy" width="570"
                                    height="230">
                                <div class="banner__content">
                                    ...
                                    <h2 class="banner__content--title"><span
                                        ...
                                        {{ __('landing.track_order_title_2') }}
                                    </h2>
                    ...
                    <div class="col-lg-6 col-md-6 mb-30">
                        <div class="banner__items position__relative">
                            <a class="banner__thumbnail display-block" href="{{ route('needs') }}"><img
                                    ...
                                    style="height: 230px; object-fit: cover;" alt="banner-img" loading="lazy"
                                    width="570" height="230">
                                <div class="banner__content">
                                    <span
                                        class="banner__content--subtitle text__secondary">{{ __('landing.request_product_subtitle') }}</span>
                                    <h2 class="banner__content--title">{{ __('landing.request_product_title') }}
