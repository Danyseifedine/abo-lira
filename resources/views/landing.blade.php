    ...
    <main class="main__content_wrapper">
        ...
        <section class="hero__slider--section">
            <div class="slider__thumbnail--style5 position-relative">
                <img class="slider__thumbnail--img__style5" src="{{ asset('assets/img/slider/home5-slider-thumb.webp') }}" alt="slider-img">
            ...
            <div class="container">
                ...
                <div class="categories__inner--style3 d-flex">
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link" href="shop.html">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="{{ asset('assets/img/categories/categories-product1.webp') }}" alt="categories-img">
                            </div>
                    ...
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link" href="shop.html">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="{{ asset('assets/img/categories/categories-product2.webp') }}" alt="categories-img">
                            </div>
                            <div class="categories__content style3">
                    ...
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link" href="shop.html">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="{{ asset('assets/img/categories/categories-product3.webp') }}" alt="categories-img">
                            </div>
                            <div class="categories__content style3">
                    ...
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link" href="shop.html">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="{{ asset('assets/img/categories/categories-product4.webp') }}" alt="categories-img">
                            </div>
                            <div class="categories__content style3">
                    ...
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link" href="shop.html">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="{{ asset('assets/img/categories/categories-product5.webp') }}" alt="categories-img">
                            </div>
                            <div class="categories__content style3">
                    ...
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link" href="shop.html">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="{{ asset('assets/img/categories/categories-product6.webp') }}" alt="categories-img">
                            </div>
                            <div class="categories__content style3">
                    ...
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link" href="shop.html">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="{{ asset('assets/img/categories/categories-product7.webp') }}" alt="categories-img">
                            </div>
                            <div class="categories__content style3">
                    ...
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link" href="shop.html">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="{{ asset('assets/img/categories/categories-product8.webp') }}" alt="categories-img">
                            </div>
                            <div class="categories__content style3">
                                ...
                                <div class="row mb--n30">
                                        ...
                                        <article class="product__card">
                                            <div class="product__card--thumbnail">
                                                <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                                    <img class="product__card--thumbnail__img product__primary--img" src="{{ asset('assets/img/product/main-product/product5.webp') }}" alt="product-img">
                                                    <img class="product__card--thumbnail__img product__secondary--img" src="{{ asset('assets/img/product/main-product/product6.webp') }}" alt="product-img">
                                                </a>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                        <article class="product__card">
                                            <div class="product__card--thumbnail">
                                                <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                                    <img class="product__card--thumbnail__img product__primary--img" src="{{ asset('assets/img/product/main-product/product7.webp') }}" alt="product-img">
                                                    <img class="product__card--thumbnail__img product__secondary--img" src="{{ asset('assets/img/product/main-product/product8.webp') }}" alt="product-img">
                                                </a>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                        <article class="product__card">
                                            <div class="product__card--thumbnail">
                                                <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                                    <img class="product__card--thumbnail__img product__primary--img" src="{{ asset('assets/img/product/main-product/product9.webp') }}" alt="product-img">
                                                    <img class="product__card--thumbnail__img product__secondary--img" src="{{ asset('assets/img/product/main-product/product10.webp') }}" alt="product-img">
                                                </a>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                        <article class="product__card">
                                            <div class="product__card--thumbnail">
                                                <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                                    <img class="product__card--thumbnail__img product__primary--img" src="{{ asset('assets/img/product/main-product/product10.webp') }}" alt="product-img">
                                                    <img class="product__card--thumbnail__img product__secondary--img" src="{{ asset('assets/img/product/main-product/product9.webp') }}" alt="product-img">
                                                </a>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                        <article class="product__card">
                                            <div class="product__card--thumbnail">
                                                <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                                    <img class="product__card--thumbnail__img product__primary--img" src="{{ asset('assets/img/product/main-product/product8.webp') }}" alt="product-img">
                                                    <img class="product__card--thumbnail__img product__secondary--img" src="{{ asset('assets/img/product/main-product/product7.webp') }}" alt="product-img">
                                                </a>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                        <article class="product__card">
                                            <div class="product__card--thumbnail">
                                                <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                                    <img class="product__card--thumbnail__img product__primary--img" src="{{ asset('assets/img/product/main-product/product6.webp') }}" alt="product-img">
                                                    <img class="product__card--thumbnail__img product__secondary--img" src="{{ asset('assets/img/product/main-product/product5.webp') }}" alt="product-img">
                                                </a>
                ...
                <div class="row  mb--n30">
                    <div class="col-lg-6 col-md-6 mb-30">
                        <div class="banner__items position__relative">
                            <a class="banner__thumbnail display-block" href="shop.html"><img class="banner__thumbnail--img banner__max--height" src="{{ asset('assets/img/banner/banner1.webp') }}" alt="banner-img">
                    ...
                    <div class="col-lg-6 col-md-6 mb-30">
                        <div class="banner__items position__relative">
                            <a class="banner__thumbnail display-block" href="shop.html"><img class="banner__thumbnail--img banner__max--height" src="{{ asset('assets/img/banner/banner2.webp') }}" alt="banner-img">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="{{ asset('assets/img/product/main-product/product1.webp') }}" alt="product-img">
                                        <img class="product__card--thumbnail__img product__secondary--img" src="{{ asset('assets/img/product/main-product/product4.webp') }}" alt="product-img">
                                    </a>
                                    <span class="product__badge">-14%</span>
                                    <ul class="product__card--action d-flex align-items-center justify-content-center">
                                        <li class="product__card--action__list">
                        ...
                        <div class="swiper-slide">
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="{{ asset('assets/img/product/main-product/product2.webp') }}" alt="product-img">
                                        <img class="product__card--thumbnail__img product__secondary--img" src="{{ asset('assets/img/product/main-product/product3.webp') }}" alt="product-img">
                                    </a>
                                    <span class="product__badge">-11%</span>
                                    <ul class="product__card--action d-flex align-items-center justify-content-center">
                                        <li class="product__card--action__list">
                        ...
                        <div class="swiper-slide">
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="{{ asset('assets/img/product/main-product/product3.webp') }}" alt="product-img">
                                        <img class="product__card--thumbnail__img product__secondary--img" src="{{ asset('assets/img/product/main-product/product1.webp') }}" alt="product-img">
                                    </a>
                                    <span class="product__badge">-18%</span>
                                    <ul class="product__card--action d-flex align-items-center justify-content-center">
                                        <li class="product__card--action__list">
                        ...
                        <div class="swiper-slide">
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="{{ asset('assets/img/product/main-product/product4.webp') }}" alt="product-img">
                                        <img class="product__card--thumbnail__img product__secondary--img" src="{{ asset('assets/img/product/main-product/product2.webp') }}" alt="product-img">
                                    </a>
                                    <span class="product__badge">-20%</span>
                                    <ul class="product__card--action d-flex align-items-center justify-content-center">
                                        <li class="product__card--action__list">
                                    ...
                                    <div class="single__product--preview single__product--thumbnail__preview swiper">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="single__product--thumbnail">
                                                    <a class="single__product--thumbnail__link display-block" href="product-details.html">
                                                        <img class="single__product--thumbnail__img" src="{{ asset('assets/img/product/big-product/product1.webp') }}" alt="product-img">
                                                    </a>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="single__product--thumbnail">
                                                    <a class="single__product--thumbnail__link display-block" href="product-details.html">
                                                        <img class="single__product--thumbnail__img" src="{{ asset('assets/img/product/big-product/product2.webp') }}" alt="product-img">
                                                    </a>
                                                    <span class="product__badge style__left">-14%</span>
                                                    <span class="product__badge--new">New</span>
                                                </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="single__product--thumbnail">
                                                    <a class="single__product--thumbnail__link display-block" href="product-details.html">
                                                        <img class="single__product--thumbnail__img" src="{{ asset('assets/img/product/big-product/product3.webp') }}" alt="product-img">
                                                    </a>
                                                    <span class="product__badge style__left">-14%</span>
                                                    <span class="product__badge--new">New</span>
                                                </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="single__product--thumbnail">
                                                    <a class="single__product--thumbnail__link display-block" href="product-details.html">
                                                        <img class="single__product--thumbnail__img" src="{{ asset('assets/img/product/big-product/product4.webp') }}" alt="product-img">
                                                    </a>
                                                    <span class="product__badge style__left">-14%</span>
                                                    <span class="product__badge--new">New</span>
                                                </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="single__product--thumbnail">
                                                    <a class="single__product--thumbnail__link display-block" href="product-details.html">
                                                        <img class="single__product--thumbnail__img" src="{{ asset('assets/img/product/big-product/product5.webp') }}" alt="product-img">
                                                    </a>
                                                    <span class="product__badge style__left">-14%</span>
                                                    <span class="product__badge--new">New</span>
                                                </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="single__product--thumbnail">
                                                    <a class="single__product--thumbnail__link display-block" href="product-details.html">
                                                        <img class="single__product--thumbnail__img" src="{{ asset('assets/img/product/big-product/product6.webp') }}" alt="product-img">
                                                    </a>
                                                    <span class="product__badge style__left">-14%</span>
                                                    <span class="product__badge--new">New</span>
                                                </div>
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="single__product--nav__items">
                                                <img class="single__product--nav__thumbnail" src="{{ asset('assets/img/product/small-product/product1.webp') }}" alt="product-nav-img">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="single__product--nav__items">
                                                <img class="single__product--nav__thumbnail" src="{{ asset('assets/img/product/small-product/product2.webp') }}" alt="product-nav-img">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="single__product--nav__items">
                                                <img class="single__product--nav__thumbnail" src="{{ asset('assets/img/product/small-product/product3.webp') }}" alt="product-nav-img">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="single__product--nav__items">
                                                <img class="single__product--nav__thumbnail" src="{{ asset('assets/img/product/small-product/product4.webp') }}" alt="product-nav-img">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="single__product--nav__items">
                                                <img class="single__product--nav__thumbnail" src="{{ asset('assets/img/product/small-product/product5.webp') }}" alt="product-nav-img">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="single__product--nav__items">
                        ...
                        <div class="col-lg-3">
                            <div class="banner__sidebar style5">
                                <div class="banner__items position__relative mb-30">
                                    <a class="banner__thumbnail display-block" href="shop.html"><img class="banner__thumbnail--img" src="{{ asset('assets/img/banner/banner18.webp') }}" alt="banner-img">
                                ...
                                <div class="banner__items position__relative">
                                    <a class="banner__thumbnail display-block" href="shop.html"><img class="banner__thumbnail--img" src="{{ asset('assets/img/banner/banner19.webp') }}" alt="banner-img">
                ...
                <div class="blog__section--inner blog__swiper--activation swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="blog-details.html"><img class="blog__card--thumbnail__img" src="{{ asset('assets/img/blog/blog1.webp') }}" alt="blog-img"></a>
                        ...
                        <div class="swiper-slide">
                            <div class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="blog-details.html"><img class="blog__card--thumbnail__img" src="{{ asset('assets/img/blog/blog2.webp') }}" alt="blog-img"></a>
                        ...
                        <div class="swiper-slide">
                            <div class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="blog-details.html"><img class="blog__card--thumbnail__img" src="{{ asset('assets/img/blog/blog3.webp') }}" alt="blog-img"></a>
                                        ...
                                        <fieldset class="variant__input--fieldset">
                                            ...
                                            <div class="variant__color d-flex">
                                                <div class="variant__color--list">
                                                    ...
                                                    <label class="variant__color--value red" for="color-red1" title="Red"><img class="variant__color--value__img" src="{{ asset('assets/img/product/small-product/product1.webp') }}" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red2" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red2" title="Black"><img class="variant__color--value__img" src="{{ asset('assets/img/product/small-product/product2.webp') }}" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red3" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red3" title="Pink"><img class="variant__color--value__img" src="{{ asset('assets/img/product/small-product/product3.webp') }}" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red4" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red4" title="Orange"><img class="variant__color--value__img" src="{{ asset('assets/img/product/small-product/product4.webp') }}" alt="variant-color-img"></label>
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
