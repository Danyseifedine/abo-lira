...
namespace Danyseifeddine\Keychain\Facades {
    /**
     * @method static \Laravel\Socialite\Contracts\Provider github()
     * @method static \Laravel\Socialite\Contracts\Provider google()
     * @method static \Laravel\Socialite\Contracts\Provider facebook()
     * @method static \Laravel\Socialite\Contracts\Provider twitter()
     * @method static \Laravel\Socialite\Contracts\Provider linkedin()
     * @method static \Laravel\Socialite\Contracts\Provider bitbucket()
     * @method static \Laravel\Socialite\Contracts\Provider gitlab()
     * @see \Danyseifeddine\Keychain\KeyChain
     */
    class KeyChain {
        /**
         * Get a Socialite provider instance
         *
         * @param string $provider
        ...
        {
            /** @var \Danyseifeddine\Keychain\KeyChain $instance */
            return $instance->provider($provider);
        }

        /**
         * Get user from provider with automatic token storage
         *
         * @param string $provider
         * @return \Laravel\Socialite\Contracts\User
         * @static
         */
        public static function getUserWithToken($provider)
        {
            /** @var \Danyseifeddine\Keychain\KeyChain $instance */
            return $instance->getUserWithToken($provider);
        }

        /**
         * Store social provider token
         *
         * @param string $provider
         * @param \Laravel\Socialite\Contracts\User $socialiteUser
         * @param mixed|null $tokenable The model to associate the token with
         * @return \Danyseifeddine\Keychain\Models\KeyChainToken
         * @static
         */
        public static function storeToken($provider, $socialiteUser, $tokenable = null)
        {
            /** @var \Danyseifeddine\Keychain\KeyChain $instance */
            return $instance->storeToken($provider, $socialiteUser, $tokenable);
        }
         ...
         * @static
         */
        public static function getTokens($provider)
        {
            /** @var \Danyseifeddine\Keychain\KeyChain $instance */
            return $instance->getTokens($provider);
        }

        /**
         * Revoke a provider token
         *
         * @param string $provider
         ...
         * @static
         */
        public static function revokeToken($provider, $providerId)
        {
            /** @var \Danyseifeddine\Keychain\KeyChain $instance */
            return $instance->revokeToken($provider, $providerId);
        }
         ...
         * @static
         */
        public static function hasValidToken($provider, $providerId)
        {
            /** @var \Danyseifeddine\Keychain\KeyChain $instance */
            return $instance->hasValidToken($provider, $providerId);
        }
...
namespace  {
    ...
    class KeyChain extends \Danyseifeddine\Keychain\Facades\KeyChain {}
